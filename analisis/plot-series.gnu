...
plot '4' using 1:4 title 'corto plazo ma2' with lines,'1' using 1:4 title 'largo plazo vari' with lines,'8' using 1:(161) title "Bicis nuevo" with point pt 5, 'conteos.txt' using 1:(160) title 'Conteos' with points lt 4, "2" using 1:4 with points
