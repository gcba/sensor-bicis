...
#cur.execute("CREATE TABLE log(id INT, id_sensor INT, dateTime INT, millis INT, valor INT);")
#cur.execute("CREATE TABLE sensores(id_sensor INT, id_dispositivo INT, descripcion TEXT );")
